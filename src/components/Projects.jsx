...
const projects = [
  { title: 'SwiftStock', label: 'SaaS Project', description: 'Inventory management SaaS platform designed to streamline stock tracking for small to medium enterprises with real-time analytics and role-based dashboards.', tech: ['Next.js', 'Prisma', 'PostgreSQL', 'Clerk.js'], github: '#', wip: true },
  ...
  { title: 'Currency Exchanger', label: 'React', description: 'Real-time currency conversion tool with live exchange rates and custom React hooks for seamless API integration.', tech: ['React', 'Custom Hooks', 'API'], live: 'https://currency-exchanger-swart.vercel.app/', github: 'https://github.com/nithishgoud1912/Currency-Exchanger.git' },
