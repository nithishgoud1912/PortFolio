...
const projects = [
  ...
  { title: 'Password Generator', label: 'React', description: 'A sleek, robust, and user-friendly Password Generator that allows users to easily generate secure, randomized passwords customized to their specific requirements.', tech: ['React', 'Vite', 'Tailwind CSS'],live:live, github: 'https://github.com/nithishgoud1912/Password-Generator.git' },
